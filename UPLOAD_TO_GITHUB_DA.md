...
> **Historisk dokument:** Denne vejledning beskriver den gamle v1.2.1-upload. Brug [README.md](README.md) og [GUIDE_DA.md](GUIDE_DA.md) til den aktuelle v1.7.0-installation og drift.
