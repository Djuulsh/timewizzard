...
const EXTRA_JS = ['v151.js', 'v152.js', 'v153.js', 'v154.js', 'v155.js', 'v156.js', 'v157.js', 'v158.js', 'v159.js', 'v1510.js', 'v1511.js', 'v1512.js', 'v1513.js', 'v1514.js', 'v1515.js', 'v1516.js', 'v1517.js', 'v1518.js', 'v1519.js'].map((fileName) => fs.readFileSync(path.join(WEB_ROOT, fileName), 'utf8')).join('\n\n');
const EXTRA_CSS = ['v151.css', 'v152.css', 'v153.css', 'v154.css', 'v155.css', 'v156.css', 'v157.css', 'v158.css', 'v159.css', 'v1510.css', 'v1511.css', 'v1512.css', 'v1513.css', 'v1515.css', 'v1516.css', 'v1517.css', 'v1518.css', 'v1519.css'].map((fileName) => fs.readFileSync(path.join(WEB_ROOT, fileName), 'utf8')).join('\n\n');
...
const V15_FEATURES = [
  ...
  'facts-fixed-width-code-labels',
  'facts-18-character-label-cell',
  'facts-value-discord-markdown-preserved',
  'separator-spacing-preview-parity',
  'separator-small-large-model',
  'button-row-structured-editor',
  'button-row-label-url-fields',
  'button-row-row-reorder',
  'button-row-column-safe-layout',
  'facts-vertical-wrap-safe-output',
  'facts-label-above-value',
  'global-block-search',
  'global-template-search',
  'template-catalog-35',
  'ten-use-case-templates',
  'context-aware-markdown-toolbar',
  'active-field-markdown-tools',
  'responsive-inspector-container-layout',
  'heading-field-priority-layout',
  'responsive-structured-editors',
  'responsive-editor-header',
  'undo-redo-always-visible',
  'secondary-actions-in-more',
  'coarse-pointer-touch-targets',
  'no-horizontal-header-scroll'
];
