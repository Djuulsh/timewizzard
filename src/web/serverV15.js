...
const EXTRA_JS = ['v151.js', 'v152.js', 'v153.js', 'v154.js', 'v155.js', 'v156.js', 'v157.js', 'v158.js', 'v159.js', 'v1510.js'].map((fileName) => fs.readFileSync(path.join(WEB_ROOT, fileName), 'utf8')).join('\n\n');
const EXTRA_CSS = ['v151.css', 'v152.css', 'v153.css', 'v154.css', 'v155.css', 'v156.css', 'v157.css', 'v158.css', 'v159.css', 'v1510.css'].map((fileName) => fs.readFileSync(path.join(WEB_ROOT, fileName), 'utf8')).join('\n\n');
